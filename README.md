...
- 🎯 **Goal:** Break into cybersecurity as a **SOC Analyst**
- 📚 **Studying:** CompTIA Security+ (SY0-701) and Cisco CyberOps Associate (200-201 CBROPS)
- 🔬 **Practicing:** Active on TryHackMe — working through Blue Team and SOC paths
- 📍 **Location:** Spain
...
| Cisco CyberOps Associate 200-201 | 🔄 Studying |

### ✅ Achieved — Credly

<!-- 
  INSTRUCCIONES PARA AÑADIR TUS BADGES DE CREDLY:
  1. Ve a credly.com y entra en tu perfil
  2. Haz clic en un badge tuyo → "Share" → "Copy the badge image URL"
  3. Pega la URL en src="..." abajo
  4. Cambia el alt="..." por el nombre de la certificación
  5. Repite para cada badge. Puedes añadir más bloques <a><img></a>
-->
...
<!--
  INSTRUCCIONES:
  Reemplaza "TU-USUARIO-TRYHACKME" con tu nombre de usuario exacto en TryHackMe
  (el mismo que aparece en tryhackme.com/p/TU-USUARIO)
  La imagen se actualiza automáticamente con tu rank actual.
-->

<div align="center">

[![TryHackMe](https://tryhackme-badges.s3.amazonaws.com/TU-USUARIO-TRYHACKME.png)](https://tryhackme.com/p/TU-USUARIO-TRYHACKME)
...
![Nmap](https://img.shields.io/badge/Nmap-214B6A?style=flat-square&logo=nmap&logoColor=white)
![Tcpdump](https://img.shields.io/badge/tcpdump-333333?style=flat-square&logoColor=white)
...
> 🗑️ *Remove any tools you haven't actually used yet — only list what you can talk about in an interview.*
...
|---|---|---|
| 🔜 Coming soon | TryHackMe room write-ups | 🔄 Building |

> *Each completed room/lab will have its own repo with notes, screenshots, and analysis.*

---

<div align="center">

📬 **Let's connect** → [LinkedIn](https://www.linkedin.com/in/TU-URL-AQUI)
